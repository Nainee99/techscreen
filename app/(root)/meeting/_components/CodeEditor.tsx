...
import { CODING_QUESTIONS , LANGUAGES } from "@/lib/constants";
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
...
function CodeEditor() {
  ...
  const runCode = useCallback(() => {
    ...
    // In a real-world scenario, you'd send the code to a backend for execution
      ...
      <ResizablePanel defaultSize={60}>
        <div className="h-full flex flex-col">
          ...
          <div className="p-4 border-t bg-muted/50">
            ...
            <pre className="bg-muted p-3 rounded-lg text-sm font-mono h-24 overflow-auto">
